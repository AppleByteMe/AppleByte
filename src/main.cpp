...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x37a9a4eb4c1f6c4151b494091852ef16a8d2ee4ad796999f2aff93533f6b40f8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        if (fTestNet)
        {
            block.nTime    = 1398278790;
            block.nNonce   = 359531495;
        }
