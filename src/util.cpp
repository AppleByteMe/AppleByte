...
const char * const BITCOIN_CONF_FILENAME = "applebyte.conf";
const char * const BITCOIN_PID_FILENAME = "applebyted.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Applebyte";
#else
    // Unix
