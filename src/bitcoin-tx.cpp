...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s artbyte-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  artbyte-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded artbyte transaction") + "\n" +
              "  artbyte-tx [options] -create [commands]   " + _("Create hex-encoded artbyte transaction") + "\n" +
              "\n";
