...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total artbyte balance of the wallet\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given artbyte address.\n"
            "\nArguments:\n"
            "1. \"artbyteaddress\"     (string, required) The artbyte address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"artbyteaddress\", (string) The artbyte address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"AWJ3HHKGjiEbJdqNyGnY16Uv7UuMiqi8e4\"")
            + HelpExampleRpc("validateaddress", "\"AWJ3HHKGjiEbJdqNyGnY16Uv7UuMiqi8e4\"")
        );
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are artbyte addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) artbyte address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"AWJ3HHKGjiEbJdqNyGnY16Uv7UuMiqi8e4\\\",\\\"ATgzzQ3WLVazJpyan9BoF4UDKruAatKuZH\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"AWJ3HHKGjiEbJdqNyGnY16Uv7UuMiqi8e4\\\",\\\"ATgzzQ3WLVazJpyan9BoF4UDKruAatKuZH\\\"]\"")
        ;
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"artbyteaddress\"  (string, required) The artbyte address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"AWJ3HHKGjiEbJdqNyGnY16Uv7UuMiqi8e4\", \"signature\", \"my message\"")
        );
