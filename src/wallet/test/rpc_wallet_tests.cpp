...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    BOOST_CHECK_THROW(CallRPC("setaccount ATgzzQ3WLVazJpyan9BoF4UDKruAatKuZH nullaccount"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("setaccount"), runtime_error);
    /* 1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4X (33 chars) is an illegal address (should be 34 chars) */
    BOOST_CHECK_THROW(CallRPC("setaccount AU62TH9HjDzj9GRPNCN7KLxTqycTPisTui nullaccount"), runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage AbsJhufLq9PAnLf1BsBWf78S47RpwnZJjL mymessage"), runtime_error);

    /* missing arguments */
    BOOST_CHECK_THROW(CallRPC("verifymessage " + demoAddress.ToString()), runtime_error);
    BOOST_CHECK_THROW(CallRPC("verifymessage " + demoAddress.ToString() + " " + retValue.get_str()), runtime_error);
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage AcWU2t34gGNyXe5gLC4XNAujimvv1dzJEH " + retValue.get_str() + " mymessage"), runtime_error);
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage AcWU2t34gGNyXe5gLC4XNAujimvv1dzJEHq " + retValue.get_str() + " mymessage").get_bool() == false);
